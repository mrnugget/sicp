...
;; Frames in an environment (each frame is a pair of lists: one for variables,
;; one for the values)
...
;; setup of initial environment and procedure lookup
...
;; Example code to run in evaluator:
;; (define (append x y)
;;   (if (null? x)
;;     y
;;     (cons (car x)
