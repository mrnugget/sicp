...
;;
;; generating executing procedures from instructions (inside the machine)
;;
...
;; generating primitive values/expressions
...
;; syntax of the machine instructions
...
;; operation expressions -- `(perform (op -) ...)`
...
;; general executing-generation generation
